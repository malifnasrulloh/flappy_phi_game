...
class _SignupViewState extends State<SignupView> {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Image(
                image: const AssetImage("assets/images/signup_prev_ui.png"),
                width: 404 * fem),
            Text("Join Us!",
            ...
            FilledButton(
                ...
                onPressed: (() async {
                  ...
                  if (AuthController.emailField.value.text.isEmail &&
                    ...
                    AccountController.signupWithEmailAndPassword()
                        .then((value) {
                      if (value) {
                        showModall(fem);
                      } else {
            ...
            TextButton(
                onPressed: () {
                  ...
                  gameController.game.overlays.remove("signup");
                  gameController.game.overlays.add('login');
                  gameController.game.pauseEngine();
                },
                child: Text(
  ...
  Future showModall(double fem) async {
    showCupertinoModalPopup(
      context: scaffoldKey.currentState!.context,
      builder: (context) => CupertinoActionSheet(
        message: Text(
            "Anda Berhasil Terdaftar\nCek kotak masuk email anda untuk verifikasi",
            style: SafeGoogleFont("Poppins",
                fontSize: 33 * fem,
                fontWeight: FontWeight.w500,
                color: Colors.black)),
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        ...
        return CupertinoAlertDialog(
          ...
          content: Text('It is our pleasure to offer you our products',
